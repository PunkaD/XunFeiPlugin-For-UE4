...
void ASpeechActor::SpeechInit()
{
	...
	{
		UE_LOG(XunFeiPluginLog, Error, TEXT("XunFei task object could not be create !"));
		return;
	}

	UE_LOG(XunFeiPluginLog, Warning, TEXT("XunFei Task Stopped !"));
	return;
}
...
FString ASpeechActor::SpeechResult()
{
	...
	UE_LOG(XunFeiPluginLog, Error, TEXT("%s"), *Result);
